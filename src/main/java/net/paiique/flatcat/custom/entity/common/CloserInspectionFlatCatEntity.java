...
public class CloserInspectionFlatCatEntity extends AbstractFlatCatEntity {
    ...
    public CloserInspectionFlatCatEntity(EntityType pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    @Override
    public ResourceLocation getCatImage() {
        return new ResourceLocation(FlatCat.MODID ,"textures/entity/closerinspection.png");
    }
}
