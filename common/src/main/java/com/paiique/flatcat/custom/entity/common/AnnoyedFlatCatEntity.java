...
public class AnnoyedFlatCatEntity extends AbstractFlatCatEntity {
    ...
    public AnnoyedFlatCatEntity(EntityType<? extends AnnoyedFlatCatEntity> pEntityType, World pLevel) {
        super(pEntityType, pLevel);
    }

    @Override
    public Identifier getCatImage() {
        return Identifier.of(FlatCats.MOD_ID ,"textures/entity/annoyed.png");
    }
}
